...
<main id="top">
  ...
  <section class="association band-paper" id="associacao"><div class="section-shell association-grid"><div class="section-label"><span>02</span><span class="vertical-line"></span><span>DEFESA<br>DA ESTÉTICA</span></div><div class="association-content"><div class="association-hero"><p class="kicker">UM MOVIMENTO NECESSÁRIO</p><div class="association-badge"><span>✓</span><strong>Defesa dos<br>Profissionais da Saúde</strong></div></div><h2>Respeito às competências.<br><em>Segurança para trabalhar.</em></h2><div class="association-sections"><div class="association-intro"><div class="mini-icon">✦</div><h3>O cenário atual</h3><p>Tramitam ações e iniciativas que buscam restringir áreas de atuação e procedimentos hoje realizados legalmente por profissionais devidamente qualificados e habilitados.</p><p>Isso atinge diretamente biomédicos, fisioterapeutas, enfermeiros, cirurgiões-dentistas, farmacêuticos, profissionais da estética e outras categorias da saúde.</p><p class="important-note">Não aceitamos que disputas institucionais sejam usadas para retirar direitos profissionais conquistados com formação, especialização e competência técnica.</p></div><div class="association-risks"><div><h3>Os riscos desta restrição</h3><ul class="risk-list"><li><strong>Inviabilidade profissional:</strong> milhares de profissionais podem, da noite para o dia, ser impedidos de exercer atividades para as quais estudaram, se especializaram e foram habilitados por seus respectivos conselhos.</li><li><strong>Prejuízo direto ao consumidor:</strong> concentrar procedimentos nas mãos de uma única categoria reduz a concorrência e pode fazer tratamentos hoje acessíveis custarem 3 ou 4 vezes mais, incluindo procedimentos como Botox e preenchimentos.</li><li><strong>Reserva de mercado:</strong> saúde não pode ser tratada como território exclusivo de uma classe quando existem outras profissões legalmente qualificadas para atuar.</li><li><strong>Menos acesso à saúde:</strong> menos profissionais disponíveis significa menos opções, filas, maior concentração e preços mais altos para a população.</li></ul></div><div class="association-commitment"><h3>Nosso compromisso</h3><p>Carla está ativamente engajada na criação de uma associação multiprofissional independente, reunindo profissionais e entidades das diferentes áreas da saúde atingidas por essas disputas.</p><p>Uma estrutura permanente de defesa jurídica, representação institucional, articulação política, informação técnica e mobilização nacional.</p><p>Não se trata de atacar médicos ou a Medicina. Apoiamos e vamos defender também os médicos para terem maior autonomia e liberdade em suas profissões, sem interferências desnecessárias que limitem sua atuação.</p></div></div></div></div><figure class="association-image"><img src="${assetBase}imagem-associacao.webp" alt="Profissionais de saúde reunidos em um ambiente de trabalho" /></figure></div></section>
